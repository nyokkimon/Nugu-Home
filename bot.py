...
# --- CONSTANTS ---
VERSION = "1.0"
REPO_URL = "https://github.com/nyokkimon/Nugu-Home"
RAW_VERSION_URL = "https://raw.githubusercontent.com/nyokkimon/Nugu-Home/main/version.txt"
...
@bot.event
async def on_ready():
    print(f'Nugu-Home v{VERSION} is online as {bot.user.name}')
